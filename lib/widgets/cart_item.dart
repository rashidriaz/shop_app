...
class CartScreenItem extends StatelessWidget {
        ...
        child: Card(
          child: Row(
            children: [
              checkBox(),
              Consumer<Products>(
                builder: (_, products, child) => Image.network(
                  products.findById(id).imageUrl,
                  fit: BoxFit.fill,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Row(
                        ...
                        children: [
                          Text(
                            "\$${cart.findById(id).pricePerProduct}",
                            style: TextStyle(
  ...
  Widget checkBox() {
    return Consumer<Cart>(
        builder: (_, cart, child) => Container(
              ...
              child: Checkbox(
                  value: cart.findById(id).isSelected,
                  onChanged: (_) {
  ...
  Widget titleAndDescription() {
    return Consumer<Products>(
      builder: (_, products, child) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
            products.findById(id).title,
            style: TextStyle(
                fontSize: 20,
          ...
          Text(
            products.findById(id).description,
            style: TextStyle(
                fontSize: 14,
